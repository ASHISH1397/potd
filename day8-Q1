...
The first and the only line of each test case contains the integer n
 (10≤n≤109) — the integer for the game. n does not have zeros in its decimal representation.
...
In the second test case Alice can swap 3 and 1: 312. After that Bob deletes the last digit: 31.
Then Alice swaps 3 and 1: 13 and Bob deletes 3, so the answer is 1.
